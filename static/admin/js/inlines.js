...
'use strict';
{
    ...
    $.fn.formset = function(opts) {
        ...
        /**
         * The "Add another MyModel" button below the inline forms.py.
         */
        const addInlineAddButton = function() {
            if (addButton === null) {
                if ($this.prop("tagName") === "TR") {
                    // If forms.py are laid out as table rows, insert the
        ...
        const addInlineClickHandler = function(e) {
            ...
            // Update number of total forms.py.
        ...
        const addInlineDeleteButton = function(row) {
            if (row.is("tr")) {
                // If the forms.py are laid out in table rows, insert
